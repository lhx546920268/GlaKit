...
object DateUtils {
    ...
    //使用单例， 提升效率
    val YMdHmsDateFormat: SimpleDateFormat = SimpleDateFormat(YMD_HMS, Locale.getDefault())
    val YMdHmDateFormat: SimpleDateFormat = SimpleDateFormat(YMD_HM, Locale.getDefault())
    val YMdDateFormat: SimpleDateFormat = SimpleDateFormat(YMD, Locale.getDefault())
    ...
    fun formatSeconds(seconds: Int): String {
        ...
        val hour = result / 60
        return java.lang.String.format(Locale.getDefault(), "%02d:%02d:%02d", hour, minute, second)
    }
