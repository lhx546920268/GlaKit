...
object RomUtils {
    ...
    private const val ROM_MIUI = "MIUI" //小米
    private const val ROM_EMUI = "EMUI" //华为
    private const val ROM_FLYME = "FLYME" //魅族
    private const val ROM_OPPO = "OPPO"
    private const val ROM_SMARTISAN = "SMARTISAN " //锤子
    private const val ROM_VIVO = "VIVO"
    private const val ROM_QIKU = "QIKU" //奇酷 360
