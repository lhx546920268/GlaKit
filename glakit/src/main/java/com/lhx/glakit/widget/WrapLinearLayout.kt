...
class WrapLinearLayout : ViewGroup {
    ...
    constructor(context: Context?, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr){
        ...
        if (attrs != null) {
            ...
            gravity = typedArray.getInt(R.styleable.WrapLinearLayout_gravity, LEFT)
            horizontalSpace = typedArray.getDimensionPixelSize(R.styleable.WrapLinearLayout_horizontalSpace, horizontalSpace)
            verticalSpace = typedArray.getDimensionPixelSize(R.styleable.WrapLinearLayout_verticalSpace, verticalSpace)
