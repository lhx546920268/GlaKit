...
//     * @return
//     */
//    fun closeAndroidQChangeWH(isChangeWH: Boolean): ImagePickerModel {
...
//     * @return
//     */
//    fun closeAndroidQChangeVideoWH(isChangeVideoWH: Boolean): ImagePickerModel {
...
//    @Deprecated("")
//    fun glideOverride(
//        @IntRange(from = 100) width: Int,
//        @IntRange(from = 100) height: Int
//    ): ImagePickerModel {
...
//     */
//    @Deprecated("")
//    fun sizeMultiplier(@FloatRange(from = 0.1) sizeMultiplier: Float): ImagePickerModel {
